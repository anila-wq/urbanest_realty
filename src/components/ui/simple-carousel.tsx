...
export function CarouselPrevious({ className = '', variant = 'outline', size = 'icon' }: CarouselPreviousProps) {
  const context = React.useContext(CarouselContext);
  ...
  return (
    <button
      ...
      className={`absolute left-4 top-1/2 -translate-y-1/2 z-10 h-10 w-10 rounded-full border border-gray-600 bg-gray-900/80 hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center ${className}`}
...
export function CarouselNext({ className = '', variant = 'outline', size = 'icon' }: CarouselNextProps) {
  const context = React.useContext(CarouselContext);
  ...
  return (
    <button
      ...
      className={`absolute right-4 top-1/2 -translate-y-1/2 z-10 h-10 w-10 rounded-full border border-gray-600 bg-gray-900/80 hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center ${className}`}
