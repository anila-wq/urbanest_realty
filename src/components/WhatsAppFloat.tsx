...
export function WhatsAppFloat() {
  const handleWhatsAppClick = () => {
    // Track WhatsApp click in Google Ads & Analytics
    if (window.gtag) {
      window.gtag('event', 'conversion', {
        'send_to': 'AW-11565888128/WhatsAppClick',
        'value': 1.0,
        'currency': 'INR'
      });
    ...
    const phoneNumber = '919972505291'; // Without + for WhatsApp
  ...
  return (
    <div className="fixed left-6 bottom-6 z-50">
      <button
        ...
        className="w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center group animate-pulse hover:animate-none"
